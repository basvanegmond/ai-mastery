...
export function FullExercise({ domain }: FullExerciseProps) {
  ...
  const difficultyColor: Record<string, string> = { Easy: 'var(--success)', Medium: 'var(--gold)', Hard: 'var(--danger)' }
      ...
      {exercises.map((ex) => {
        ...
        return (
          <div key={ex.id}>
              ...
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <span
                    ...
                    style={{
                      background: `${difficultyColor[ex.difficulty]}14`,
            ...
            {active && (
              <div
                className="rounded-b-xl p-4 space-y-3 mt-px"
                ...
                {submitted ? (
                    ...
                    <div className="flex gap-2">
                      {remaining > 0 && (
                        <button
                          ...
                          className="interactive flex-1 py-2 rounded-lg text-sm"
                          style={{
                            background: 'var(--gold)',
                            color: 'white',
                            fontFamily: 'DM Mono, monospace',
                      ...
                      <button
                        ...
                        className="interactive py-2 px-4 rounded-lg text-sm"
                        style={{
                  ...
                  <>
                      ...
                      <div className="flex gap-1">
                        {[1, 2, 3, 4, 5].map((s) => (
                          <button
                            key={s}
                            onClick={() => setStars(s)}
                            className="interactive text-lg"
                            style={{ color: s <= stars ? 'var(--gold)' : 'var(--border-mid)' }}
                          >
                            ★
                          </button>
                        ))}
                      ...
                      <div className="flex gap-1">
                        {GRADES.map((g) => (
                          <button
                            ...
                            className="interactive text-xs px-2 py-1 rounded"
                            style={{
                              background: grade === g ? 'var(--gold)' : 'transparent',
                              color: grade === g ? 'white' : 'var(--text-muted)',
                              fontFamily: 'DM Mono, monospace',
                              border: `1px solid ${grade === g ? 'var(--gold)' : 'var(--border)'}`,
                            }}
                          >
                            {g}
                          </button>
                    ...
                    <button
                      ...
                      style={{
                        background: stars > 0 ? 'var(--gold)' : 'transparent',
                        color: stars > 0 ? 'white' : 'var(--text-muted)',
                        fontFamily: 'DM Mono, monospace',
                        border: stars === 0 ? '1px dashed var(--border)' : 'none',
